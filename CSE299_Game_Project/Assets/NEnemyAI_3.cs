...
public class NEnemyAI_3 : MonoBehaviour
{
    ...
    public float nextwaypointDistance3 = 1f;
    ...
    void FixedUpdate()
    {
        ...
        // We are pointing and arrow from our current position to where we want to be which is our current waypoint and making sure the lenght of that arrow is 3 (normalized)
